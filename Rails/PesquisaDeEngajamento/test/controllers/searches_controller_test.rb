...
class SearchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create search" do
    assert_difference("Search.count") do
      post searches_url, params: { search: { active: @search.active, name: @search.name, year: @search.year } }
    end
  ...
  test "should update search" do
    patch search_url(@search), params: { search: { active: @search.active, name: @search.name, year: @search.year } }
