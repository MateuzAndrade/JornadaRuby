...
class ManagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manager" do
    assert_difference("Manager.count") do
      post managers_url, params: { manager: { name: @manager.name, sector_id: @manager.sector_id } }
    end
  ...
  test "should update manager" do
    patch manager_url(@manager), params: { manager: { name: @manager.name, sector_id: @manager.sector_id } }
